...
const std::string selectLevelNames[] = {"Easy", "Medium", "Hard"};
...
const std::vector SOUNDS_NAMES = {"gamePlay.wav", "menuMusic.wav", "ClickSound.wav",
								  "ThiefTakeKey.wav", "GrabPresent.wav", "TeleportEnter.wav",
								  "OpenGate.wav", "WinLevel.wav", "fire.wav", "OrkDeathSoundEffect.wav"};

const std::vector NAMES = {"play1.png", "play2.png", "play3.png", "menu.png", "help.png", "SelectLevel.png",
						   "king.png", "mage.png", "warrior.png", "thief.png", "crown.png", "gate.png", "fire.png",
